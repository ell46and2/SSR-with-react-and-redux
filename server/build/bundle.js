...
exports.default = [{
	...
	routes: [_extends({}, _HomePage2.default, { // Gives us - component: HomePage
		path: '/',
		exact: true
	}), _extends({}, _UsersListPage2.default, { // gives us - component: UsersListPage, loadData: loadData
		path: '/users'
	}), _extends({}, _AdminsListPage2.default, { // gives us - component: AdminsListPage, loadData: loadData
		path: '/admins'
...
exports.default = function (req, store, context) {
	// Receives req paramter from our express route in index.js
